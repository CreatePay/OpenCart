...
class Gateway
{
	...
	public function hostedRequest(array $request, bool $iframe = false, bool $modal = false): string
	{
		...
		if ($iframe) {
			$htmlForm = <<<HTML
<iframe id="paymentgatewayframe" allow="payment https://payments.createpay.com https://gateway.cardstream.com" name="paymentgatewayframe" frameBorder="0" seamless="seamless" style="width:699px; height:1100px;margin: 0 auto;display:block;"></iframe>
HTML;
